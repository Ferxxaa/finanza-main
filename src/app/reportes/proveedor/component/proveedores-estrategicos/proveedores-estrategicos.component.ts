...
@Component({
  selector: 'app-proveedores-estrategicos',
  templateUrl: './proveedores-estrategicos.component.html',
  styleUrls: ['../resumen-anual/resumen-anual.component.css']
})
export class ProveedoresEstrategicosComponent implements OnInit {
  ...
  ordenaPorCantidad(a: mReporteProveedor, b: mReporteProveedor) {
    if (a.OcEvaluadas < b.OcEvaluadas)
      return 1
    if (a.OcEvaluadas > b.OcEvaluadas)
      return -1
    return 0
